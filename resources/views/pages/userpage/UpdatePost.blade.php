                        ...
                        <form method="POST" action="{{ route('post.update', $post->post_id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" name="image"
                                    accept="image/*">
                                <img id="imagePreview"
                                    src="{{ $post->post_image ? asset('storage/' . $post->post_image) : '#' }}"
                                    alt="Image Preview" class="img-fluid mt-2" style=" max-height: 200px;" />
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" id="post" name="post" required>
                                    ...
                                    <option value="1" {{ old('post', $post->viewable) == '1' ? 'selected' : '' }}>
                                        Private</option>
                                    <option value="0" {{ old('post', $post->viewable) == '0' ? 'selected' : '' }}>
                                        Public</option>
                                </select>
